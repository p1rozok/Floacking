...
public class MoveHook : MonoBehaviour
{
    ...
    //    if (_transformList.Count > 1)
    //    {
    //        Debug.Log("ֿכרהא");
    //        Vector3 targetPosition = _transformList[_transformList.Count - 1];
    //        _transformList.Remove(_transformList[_transformList.Count - 1]);
